...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { booked: @hotel.booked, destination_id: @hotel.destination_id, name: @hotel.name, url: @hotel.url }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { booked: @hotel.booked, destination_id: @hotel.destination_id, name: @hotel.name, url: @hotel.url }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
