...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { arrival_date: @destination.arrival_date, departure_date: @destination.departure_date, honeymoon_id: @destination.honeymoon_id }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { arrival_date: @destination.arrival_date, departure_date: @destination.departure_date, honeymoon_id: @destination.honeymoon_id }
    assert_redirected_to destination_path(assigns(:destination))
  end
